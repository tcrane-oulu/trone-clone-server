...
export class PacketBuffer {
  ...
  /**
   * The number of bytes between the data and the buffer index.
   */
  get remaining(): number {
    return this.internalLength - this.bufferIndex;
  }
  ...
  reset(): void {
    ...
    this.internalLength = DEFAULT_SIZE;
  }
}
